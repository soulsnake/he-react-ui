...
const loadingSkeleton = (
  <Fragment>
    <Paragraph key="1">
      This content is rendering as defined by the loadingSkeleton property and due to the loading property being set to
      true.
    </Paragraph>
...
export default {
  ...
  children: (
    <Fragment>
      <Paragraph>
        This component should be used for most standard content below the hierarchical level of the entire page.
      </Paragraph>
