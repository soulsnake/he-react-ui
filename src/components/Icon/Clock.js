...
export default function Clock (props) {
  const {className, height, width, ...restProps} = props

  return (
    <svg className={className} width={`${width}px`} height={`${height}px`} {...restProps} viewBox="0 0 26 26" version="1.1" xmlns="http://www.w3.org/2000/svg">
